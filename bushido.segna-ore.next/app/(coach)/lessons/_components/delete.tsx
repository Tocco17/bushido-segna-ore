		...
		<AlertDialog>
			...
			<AlertDialogContent>
				<AlertDialogHeader>
					...
					<AlertDialogDescription>
						You are about to delete the lesson you have performed on date <strong>{getLessonDateString(lesson)}</strong>.
				...
				<AlertDialogFooter>
					...
					<AlertDialogAction
						onClick={() => toast.success(
							"Delete complete",
							{
								description: `Lesson on date ${getLessonDateString(lesson)} has been succesfully deleted.`
							})}
					>
						Continue
					</AlertDialogAction>
